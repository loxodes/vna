...
# bitbang with hwiopy library, a few orders of magnitude faster than BBIO
# use BBIO for pin initialization, hwiopy for high speed access
# https://github.com/Badg/hwiopy 
class hwiopy_spi:
   def __init__(self, spi_cs, spi_mosi, spi_miso, spi_clk):
        self.spi_cs = spi_cs
        self.spi_mosi = spi_mosi
